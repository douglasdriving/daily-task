  ...
  return (
    <div className="max-w-2xl mx-auto p-8">
      <div className="text-center mb-12">
        ...
        <p className="text-xl font-light text-burgundy-light dark:text-primary-200">
            ...
            <Card className="cursor-pointer transition-all hover:shadow-xl hover:scale-105 active:scale-100">
              <div className="flex items-center justify-center py-2">
                <div className="flex-1 text-center">
                  <h3 className="text-xl font-medium text-burgundy dark:text-peach">
                    {option.label}
                  </h3>
                  <p className="text-sm font-light text-burgundy-light dark:text-primary-200 mt-1">
                    {option.description}
                  </p>
                </div>
              </div>
